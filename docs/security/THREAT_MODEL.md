...
- Connect the protected phrase and recovery-key export to the pre-write guard,
  then exercise power-loss and device-swap cases on disposable persistent VM
  disks.
