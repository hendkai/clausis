...
## Local speech stack in the 0.1.0 ISO
...
their complete license metadata in `/opt/voiceos/lib/python*/site-packages/`.
...
The model is used only for local transcription. VoiceOS does not retain raw
